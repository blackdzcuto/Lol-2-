...
let a = await loadImage(pathAva)
    ...
    ctx.fillStyle = "#FFF"
    ctx.fillText("BLACK BOT", canvas.width / 2 - 660, 1600);
    ctx.save();
    ...
    ctx.fillStyle = "#000"
    ctx.fillText("@comming soon", 1200, 2750);
    ctx.fillStyle = "#FFF"
    ctx.fillText("blacksieudv.tk", 1600, 3150);
    ctx.fillStyle = "#000"
   ctx.fillText("fb.me/100005201702431", 2000, 3600);
    ctx.beginPath();
